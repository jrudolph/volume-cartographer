...
namespace volcart
{
    ...
    class LRUCache2 final : public Cache<TKey, TValue>
    {
    public:
        ...
        /** Shared pointer type */
        using Pointer = std::shared_ptr<LRUCache2<TKey, TValue, THasher>>;
        ...
        explicit LRUCache2(std::size_t capacity) : BaseClass(capacity) {}
        
        /** @overload LRUCache2() */
        static auto New() -> Pointer
        {
            return std::make_shared<LRUCache2<TKey, TValue, THasher>>();
        }
        
        /** @overload LRUCache2(std::size_t) */
        static auto New(std::size_t capacity) -> Pointer
        {
            return std::make_shared<LRUCache2<TKey, TValue, THasher>>(capacity);
        }
        /**@}*/
